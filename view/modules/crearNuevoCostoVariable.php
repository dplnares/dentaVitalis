    ...
    <div id="layoutSidenav_content">
      <main class="bg">
        <div class="container-fluid px-4">
          <h1 class="mt-4">Nuevo Costo Variable</h1>
        </div>
          ...
          <form role="form" method="post" class="row g-3 m-2 formularioCostoVariable">
            ...
            <span class="border border-3 p-3">
              <div class="container row g-3">
                ...
                <div class="col-md-4">
                  <label for="nombreProveedorGastoVariable" class="form-label" style="font-weight: bold">Nombre de Proveedor</label>
                  <input type="text" class="form-control" id="nombreProveedorGastoVariable" name="nombreProveedorGastoVariable">
                </div>

                <!-- Numero de documento -->
                <div class="col-md-4">
                  <label for="numeroDocumentoGastoVariable" class="form-label" style="font-weight: bold">Número de documento</label>
                  <input type="text" class="form-control" id="numeroDocumentoGastoVariable" name="numeroDocumentoGastoVariable">
                </div>

                <!-- Seleccionar la fecha del costo -->
                <div class="col-md-4">
                  <label for="fechaIngresoGastoVariable" class="form-label" style="font-weight: bold">Fecha de Documento</label>
                  <input type="date" class="form-control" id="fechaIngresoGastoVariable" name="fechaIngresoGastoVariable">
                </div>
              </div>
            </span>
...
<?php
  $crearCostoVariable = new ControllerCostos;
  $crearCostoVariable -> ctrCrearNuevoCostoVariable();
?>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <table class="table table-striped dt-responsive tablaGastos" width="100%">
          ...
          <tbody>
            <?php
              $listaGastos = ControllerGastos::ctrMostrarGastosPorTipo("2");
