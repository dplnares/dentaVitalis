    ...
    <div id="layoutSidenav_content">
      <main class="bg">
        <div class="container-fluid px-4">
          <h1 class="mt-4">Todos los Tratamientos</h1>
          <div class="d-flex m-2">
              <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modalAgregarTratamiento">
                Agregar Tratamiento
              </button>
            </div>
          ...
          <div class="card mb-4">
            ...
            <div class="card-body">
              <table id="datatablesSimple" class="data-table-Tratamiento table">
                <thead>
                  <tr>
                    <th>#</th>
                    <th>Nombre</th>
